 ...
 * This is designed to be run out of a running BORG instance - not a web server
 * The databases already open by the application will be used
 */
public class SingleInstanceHandler
{
	...
	private static BeanDB getBeanDB(IRemoteProxy.Parms parms)
		throws Exception
	{

...
import com.mbcsoft.platform.ui.util.TableSorter;
...
class SqlRunner extends JFrame {
	...
	static private final Logger log = Logger.getLogger(SqlRunner.class.getName());
	...
	private void runbuttonActionPerformed() {
		try {
			...
			// run the sql
			ResultSet r = JdbcDB.execQuery(this.editor.getText());

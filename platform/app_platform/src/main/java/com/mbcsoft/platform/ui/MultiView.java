...
import com.mbcsoft.platform.ui.util.JTabbedPaneWithCloseIcons;
import com.mbcsoft.platform.ui.util.MemoryPanel;
...
public class MultiView extends View {
	...
	static private PrefName MULTIVIEWSIZE = new PrefName("multiviewsize",
			"-1,-1,-1,-1,Y");

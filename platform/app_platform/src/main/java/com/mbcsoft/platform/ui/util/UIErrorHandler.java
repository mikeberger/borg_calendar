...
package com.mbcsoft.platform.ui.util;

import java.util.logging.Logger;

import com.mbcsoft.platform.common.ErrorHandler;
...
public class UIErrorHandler implements ErrorHandler {
	...
	static private final Logger log = Logger.getLogger(UIErrorHandler.class.getName());

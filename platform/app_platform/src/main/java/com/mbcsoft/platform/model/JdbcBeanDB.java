 ...
 */
public abstract class JdbcBeanDB<T extends KeyedEntity<T>> {
	 ...
	 * @throws SQLException
	 */
	public abstract PreparedStatement getPSOne(int key) throws SQLException;
	 ...
	 * @throws SQLException
	 */
	public abstract PreparedStatement getPSAll() throws SQLException;
	 ...
	 * @throws SQLException
	 */
	public abstract T createFrom(ResultSet rs) throws SQLException;
}

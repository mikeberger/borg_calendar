 ...
 */
public class SyncOptionsPanel extends OptionsPanel {
	...
	public void applyChanges() {
		...
		Prefs.putPref(SyncModule.SYNCUSER, username.getText());
		try {
	...
	public void loadOptions() {
		...
		username.setText(Prefs.getPref(SyncModule.SYNCUSER));
	...
	public static void sep(String s) throws Exception {
		if ("".equals(s)) {
			Prefs.putPref(SyncModule.SYNCPW, s);
			return;
		}
		String p1 = Prefs.getPref(SyncModule.SYNCPW2);
		if ("".equals(p1)) {
			KeyGenerator keyGen = KeyGenerator.getInstance("AES");
			SecretKey key = keyGen.generateKey();
			BASE64Encoder b64enc = new BASE64Encoder();
			p1 = b64enc.encode(key.getEncoded());
			Prefs.putPref(SyncModule.SYNCPW2, p1);
		}
		...
		ba = baos.toByteArray();
		BASE64Encoder b64enc = new BASE64Encoder();
		Prefs.putPref(SyncModule.SYNCPW, b64enc.encode(ba));
	}

	public static String gep() throws Exception {
		String p1 = Prefs.getPref(SyncModule.SYNCPW2);
		String p2 = Prefs.getPref(SyncModule.SYNCPW);
		if ("".equals(p2))
			return p2;

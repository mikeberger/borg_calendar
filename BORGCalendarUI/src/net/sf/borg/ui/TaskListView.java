...
public class TaskListView extends View {
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        edittypes.setText(java.util.ResourceBundle.getBundle("resource/borg_resource").getString("edit_types"));
    ...
    private void edittypesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_edittypesActionPerformed
        TaskConfigurator.getReference().show();
    }//GEN-LAST:event_edittypesActionPerformed

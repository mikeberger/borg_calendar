...
public class TaskListView extends View {
	...
	tp.addTab(Resource.getPlainResourceString("projects"), getProjectPanel());
	tp.addTab(Resource.getPlainResourceString("tasks"), getTaskListPanel());
	...
	JMenuItem printit = new JMenuItem();
	JMenuItem exitMenuItem = new JMenuItem();
	JMenu editMenu = new JMenu();

	JMenu optMenu = new JMenu();
    ...
    private boolean onProjectTab()
    {
	if( tp.getSelectedComponent() == projectPanel)
	    return true;
	return false;
    }
...
*/
		...
		if (ro[3] == null)
		    ...
		    Date dd = (Date) ro[3];
		    ro[6] = new Integer(TaskModel.daysLeft(dd));
		}
	...
	if (taskListPanel == null) {
	    ...
	    taskListPanel.add(jButton21, gridBagConstraints8);
	    taskListPanel.add(jTextField3, gridBagConstraints9);
	    taskListPanel.add(jScrollPane1, gridBagConstraints11);
	    taskListPanel.add(getJPanel2(), gridBagConstraints15);
	   
	    taskListPanel.add(getCaseBox(), gridBagConstraints2);
	    ...
	    // save table cell default renderer for when the custom one is
	    // not being
	    // used
	    ...
	    taskTable.setModel(new TableSorter(new String[] {
		    ...
		    new Class[] { java.lang.Integer.class,
			    ...
			    Date.class, Date.class, java.lang.Integer.class,
	...
	if (projectPanel == null) {
	    ...
	    gridBagConstraints11.insets = new java.awt.Insets(4, 4, 4, 4);
	    projectPanel.add(jScrollPane1, gridBagConstraints11);
	    ...
	    projectTable.setDefaultRenderer(Integer.class,
		    new TaskListView.ProjIntRenderer());
	    ...
	    projectTable.setModel(new TableSorter(new String[] {
		    ...
		    new Class[] { java.lang.Integer.class,
			    ...
			    Date.class, java.lang.Integer.class,
			    Integer.class, Integer.class, java.lang.String.class }));
	    ...
	    projectTable.getColumnModel().getColumn(7).setPreferredWidth(400);
	    ...
	    //projectTable.setPreferredSize(new java.awt.Dimension(700, 500));

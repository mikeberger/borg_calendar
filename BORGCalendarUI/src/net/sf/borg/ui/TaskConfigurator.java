...
public class TaskConfigurator extends View {
	...
	private void initialize() {
		this.setTitle("Task State Editor");
	...
	private JMenuItem getJMenuItem() {
		if (jMenuItem == null) {
			...
			jMenuItem.setText("Add Type");
			jMenuItem.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					String newtype = JOptionPane
							.showInputDialog("New Task Type");
					if (newtype == null)
						return;
	...
	private JMenuItem getJMenuItem1() {
		if (jMenuItem1 == null) {
			...
			jMenuItem1.setText("Rename Type");
	...
	private JMenuItem getJMenuItem2() {
		if (jMenuItem2 == null) {
			...
			jMenuItem2.setText("Delete Type");
			jMenuItem2.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					int ret = JOptionPane.showConfirmDialog(null,
							"Really Delete " + typelist.getSelectedValue(),
		...
		if (jMenuItem3 == null) {
			...
			jMenuItem3.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					String newstate = JOptionPane.showInputDialog("New State");
					if (newstate == null)
						return;
	...
	private JMenuItem getJMenuItem4() {
		if (jMenuItem4 == null) {
			...
			jMenuItem4.setText("Rename State");
	...
	private JMenuItem getJMenuItem5() {
		if (jMenuItem5 == null) {
			...
			jMenuItem5.setText("Delete State");
			jMenuItem5.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					int ret = JOptionPane.showConfirmDialog(null,
							"Really Delete " + statelist.getSelectedValue(),
							"Confirm Delete", JOptionPane.OK_CANCEL_OPTION);
					if (ret != JOptionPane.OK_OPTION)
						return;
		...
		if (jMenuItem6 == null) {
			...
			jMenuItem6.addActionListener(new java.awt.event.ActionListener() { 
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					String ns = (String) JOptionPane.showInputDialog(null,"Select next state", 
							"Select next state", JOptionPane.QUESTION_MESSAGE,
		...
		if (jMenuItem8 == null) {
			...
			jMenuItem8.addActionListener(new java.awt.event.ActionListener() { 
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					String cb = JOptionPane.showInputDialog("New Subtask Value");
					if (cb == null)
						return;

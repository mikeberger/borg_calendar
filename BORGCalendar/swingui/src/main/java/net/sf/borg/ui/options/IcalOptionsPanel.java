...
public class IcalOptionsPanel extends OptionsPanel {
	...
	public IcalOptionsPanel() {
		...
		calpanel.add(new JLabel(Resource.getResourceString("CALDAV_Server")),
				GridBagConstraintsFactory.create(0, 0, GridBagConstraints.BOTH));
		calpanel.add(caldavServer, GridBagConstraintsFactory.create(1, 0, GridBagConstraints.BOTH, 1.0, 0.0));
		...
		calpanel.add(caldavPath, GridBagConstraintsFactory.create(3, 0, GridBagConstraints.BOTH, 1.0, 0.0));
		...
		calpanel.add(caldavUser, GridBagConstraintsFactory.create(1, 1, GridBagConstraints.BOTH, 1.0, 0.0));

		JLabel pl2 = new JLabel(Resource.getResourceString("CALDAV_Password"));
		calpanel.add(pl2, GridBagConstraintsFactory.create(2, 1, GridBagConstraints.BOTH));
		pl2.setLabelFor(caldavPassword);
		calpanel.add(caldavPassword, GridBagConstraintsFactory.create(3, 1, GridBagConstraints.BOTH, 1.0, 0.0));
		...
		calpanel.add(caldavPrincipalPath, GridBagConstraintsFactory.create(1, 3, GridBagConstraints.BOTH, 1.0, 0.0));
		...
		calpanel.add(caldavSSL, GridBagConstraintsFactory.create(0, 5, GridBagConstraints.BOTH));
		calpanel.add(caldavSelfSigned, GridBagConstraintsFactory.create(2, 5, GridBagConstraints.BOTH));

		GridBagConstraints gbc = GridBagConstraintsFactory.create(0, 6, GridBagConstraints.BOTH, 1.0, 0.0);

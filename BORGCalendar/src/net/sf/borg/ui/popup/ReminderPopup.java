...
class ReminderPopup extends View {
	...
	private JButton getDoneNoDeleteButton() {
		if (doneNDButton == null) {
			doneNDButton = new JButton();
	...
	private JPanel getJPanel1() {
		if (jPanel1 == null) {
			...
			jPanel1.add(getDismissButton(), gridBagConstraints);
			if (appt.getTodo() == true) {
				gridBagConstraints.gridx = 1;
				gridBagConstraints.gridy = 0;
				jPanel1.add(getDoneButton(), gridBagConstraints);
				gridBagConstraints.gridx = 2;
				gridBagConstraints.gridy = 0;
				jPanel1.add(getDoneNoDeleteButton(), gridBagConstraints);
			}
		}
		return jPanel1;
	}

...
public class TaskListPanel extends JPanel implements Model.Listener {
		...
		try {
			...
			while (ti.hasNext()) {
				...
				if (task.getDueDate() != null) {
					ro[7] = new Integer(TaskModel.daysBetween(task
	...
	private void initComponents() throws Exception {
		...
		// taskTable.setPreferredSize(new java.awt.Dimension(1000, 500));
		...
		// taskTable.setPreferredScrollableViewportSize(new Dimension(1200,
		// 400));

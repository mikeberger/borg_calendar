...
class ProjectView extends DockableView {
	...
	jPanel3.setBorder(new javax.swing.border.TitledBorder(Resource.getResourceString("ProjectInformation")));
	...
	add(jPanel3, gridBagConstraints21); // Generated
	...
	if (p != null) {
	    ...
	    Collection ptasks = TaskModel.getReference().getTasks(p.getId().intValue());

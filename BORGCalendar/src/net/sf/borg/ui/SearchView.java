...
public class SearchView extends DockableView {
	...
	jTable1
		.setModel(new TableSorter(new String[] { Resource.getPlainResourceString("Date"),
			Resource.getPlainResourceString("Item"), "key" }, new Class[] { Date.class, java.lang.String.class,
			Integer.class }));
	...
	if (jPanel == null) {
	    ...
	    jPanel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, Resource.getResourceString("Search_Results"),
	...
	for (int i = 0; i < appts_.size(); i++) {
	    ...
	    if (selcat.equals(CategoryModel.UNCATEGORIZED) && r.getCategory() != null
		    && !r.getCategory().equals(CategoryModel.UNCATEGORIZED))
		continue;

	    if (!selcat.equals("") && !selcat.equals(CategoryModel.UNCATEGORIZED) && !selcat.equals(r.getCategory()))
		continue;

 ...
 */
/*
 * THIS FILE HAS NOT YET BEEN FULLY CLEANED UP.
 * OptionsView is the worst of the atrocities generated by the netbeans visual editor
 * and made worse by the eclipse visual editor. There are so many fields and widgets
 * that it has never been worth while to completely untangle the mess.
 * The hundreds of lines of grid bag mess have been cleaned up. Many variables
 * have been renamed to have meaningful names.
 */
public class OptionsView extends View {
	...
	/*
	 * This list of fields are mostly UI components or other objects
	 * that hold an option value.
	 * Many are only used in one place and should not be class level, but
	 * THATS WHERE THE DAMN VISUAL CODE GENERATORS PUT THEM
	 * There need to be cleaned up at some point
	 * 
	 * 
	 */
	...
	/**
	 * save all preferences to the preference store based on the current UI values
	 */
	...
	/**
	 * change the database settings - will update the settings and then restart the program
	 */
	...
	/**
	 * show the db settings panel that corresponds to the
	 * chosen db type and hide the other panels
	 * @param type db type
	 */
	 ...
	 * @param fontname the preference name associated with the font
	 */
	...
	private JPanel getAppearancePanel() {
		...
		appearancePanel.add(truncbox, GridBagConstraintsFactory.create(1,
	...
	private void initComponents() {
		...
		/*
		 * The visual editors put this mess of initializers here
		 * and it's never been worth it to split them up and move them to where
		 * they should go
		 */
